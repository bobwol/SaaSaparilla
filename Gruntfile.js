		...
		makepot: {
			target: {
				options: {
					...
					exclude: ['build/.*'],
					mainFile: 'saasaparilla.php',    // Main project file.
					potFilename: 'saasaparilla.pot',    // Name of the POT file.
					potHeaders: {
					...
					processPot: function( pot, options ) {
						pot.headers['report-msgid-bugs-to'] = 'https://saasaparilla.com/';
